...
// Its Easier to Just alayas have an additional 'Pivot' Username ,
// Because when trying to get your 'own' user_id , it doesn't seem to work
// So you have to use the Pivot User , to get someone else's user_id
const PersonalPivot = require( "./main.js" ).personal.twitch_pivot;
    ...
    return new Promise( async function( resolve , reject ) {
        try {
            let headers = {
                ...
                'Client-ID': PersonalPivot.client_id ,
            };
